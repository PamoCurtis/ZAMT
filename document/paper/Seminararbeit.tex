...
\title{
	SymBioSys 2025: Zelluläre Automaten für Tumormodellierung
}
...
Zur Beantwortung unserer Fragestellung, haben wir ein Modell innerhalb des frei-zugänglichen NetLogo Programm erstellt und verfeinert und es anschließend mit den Ergebnissen, Modellen und Konklusionen unserer Quellen vergliechen.
\end{abstract}
...
\section{Einführung}
[Irgendwas über unsere Motivation]
...
[Unsere Vorstellung von unserem Modell und wie wir zu diesen Modell gekommen sind.]
